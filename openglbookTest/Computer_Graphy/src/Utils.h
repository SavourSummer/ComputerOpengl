...
private:
	...
	static GLuint prepareShader(int shadrType, const std::string& shaderPath);
...
public:
	...
	static GLuint createShaderProgram(const std::string& cp);
	static GLuint createShaderProgram(const std::string& vp, const std::string& fp);
	...
	static GLuint loadCubeMap(const char* magDir);
